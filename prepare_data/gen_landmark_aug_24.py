...
def GenerateData(ftxt, output,net,argument=False):
    ...
    for (imgPath, bbox, landmarkGt) in data:
        ...
        F_landmarks.append(landmark.reshape(74))
        landmark = np.zeros((37, 2))        
        if argument:
            idx = idx + 1
            if idx % 100 == 0:
            ...
            for i in range(10):
                ...
                if iou > 0.65:
                    ...
                    if random.choice([0,1]) > 0:
                        ...
                        F_landmarks.append(landmark_flipped.reshape(74))
                    #rotate
                    if random.choice([0,1]) > 0:
                        ...
                        F_landmarks.append(landmark_rotated.reshape(74))
